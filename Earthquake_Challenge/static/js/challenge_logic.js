...
// We create the third title layer that will be the background of our map.
...
let majorEQ = new L.LayerGroup(); // adding 3rd layer

// 2. Add a reference to the tectonic plates group to the overlays object.
let overlays = {
  "Earthquakes": allEarthquakes,
  "Tectonic Plates": tectonicPlates,
  "Major Earthquakes": majorEQ // adding reference to major earthquake data
};
...
L.geoJson(platesData, {
  ...
  // Add tectonic layer group variable .addTo(tectonicPlates), close geoJSON() layer
